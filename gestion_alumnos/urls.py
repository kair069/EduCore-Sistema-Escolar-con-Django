...
from .views import exportar_asistencias_excel, filtrar_asistencias, home, salida
...
from gestion_alumnos.views import exportar_asistencias_excel
...
urlpatterns = [
    ...
    path('asistencias/filtrar/', filtrar_asistencias, name='filtrar_asistencias'),
   path('asistencias/exportar/', exportar_asistencias_excel, name='exportar_asistencias_excel'),
  ...
  path('calificaciones/exportar_excel/', exportar_calificaciones_excel, name='exportar_calificaciones_excel'),
    ...
    path('usuarioscrearnuevo/nuevo/', views.user_create, name='user_create'),
